    ...
    angular.module('mdDateTime').run(['$templateCache',
        function ($templateCache) {
            $templateCache.put('md-date-time.tpl.html', [
                ...
                '          <input type="tel" disabledx min="{{_hours24 ? 0 : 1}}" max="{{_hours24 ? 23 : 12}}" style="margin:0; font-size: 6rem; text-align: center; float: left; width: 10rem;" ng-model="clock._hours">',
                ...
                '          <input type="tel" disabledx min="0" max="59" ng-model="clock._minutes" style="margin:0; font-size: 6rem; text-align: center; float: right; width: 10rem;">',
    ...
    function mdDatetimeInline() {
        return {
            ...
            template: [
                ...
                '   </div>',
                '   <div class="show-time" ng-show="{{vm.mode()}}" ng-click="vm.datetime=\'time\'" ng-class="vm.datetime === \'date\' ? \'show\' : \'\'">',
